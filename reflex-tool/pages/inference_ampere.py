"""Ampere Architecture Inference page."""
import reflex as rx
...
def inference_ampere_page() -> rx.Component:
    """Ampere Architecture Inference page."""
    return rx.hstack(
        navbar(),
        rx.box(
            rx.container(
                rx.vstack(
                    # Title
                    rx.heading(
                        "Ampere Architecture - Model Inference",
                        font_size="1.8rem",
                        font_weight="600",
                        margin_top="1.5rem",
                        margin_bottom="1rem",
                    ...
                    rx.hstack(
                        ...
                        rx.select(
                            ...
                            on_change=State.set_modelopt_version_and_reload_ampere_inference,
                            size="2",
                            width="150px",
                        ),
                        rx.text(
                        ...
                        rx.select(
                            ...
                            on_change=State.set_cpu_arch_and_reload_ampere_inference,
                            size="2",
                            width="150px",
                        ),
                        spacing="3",
                        ...
                        rx.vstack(
                            rx.hstack(
                                ...
                                rx.button(
                                    ...
                                    "refresh",
                                    on_click=lambda: [State.load_ampere_inference_data, rx.toast.success("Data refreshed successfully")],
                                    variant="outline",
                                    size="2",
                                    color_scheme="green",
                                ),
                    ...
                    spacing="4",
                    padding="2rem",
                    on_mount=State.load_ampere_inference_data,
                ),
                max_width="1200px",
            ),
            margin_left="250px",
