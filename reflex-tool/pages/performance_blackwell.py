                ...
                rx.vstack(
                    ...
                    rx.box(
                        rx.vstack(
                            ...
                            rx.hstack(
                                rx.badge("B100", color_scheme="green", variant="soft", size="2"),
                                rx.badge("B200", color_scheme="green", variant="soft", size="2"),
                                spacing="2",
                                wrap="wrap",
                            ),
                        ),
                    ...
                    rx.hstack(
                        ...
                        rx.select(
                            ...
                            on_change=State.set_cpu_arch_and_reload_blackwell_performance,
                            size="2",
                            width="150px",
                        ),
                        spacing="3",
                        ...
                        rx.vstack(
                            rx.hstack(
                                ...
                                rx.button(
                                    ...
                                    "refresh",
                                    on_click=lambda: [State.load_blackwell_performance_data, rx.toast.success("Data refreshed successfully")],
                                    variant="outline",
                                    size="2",
                                    color_scheme="green",
                                ),
