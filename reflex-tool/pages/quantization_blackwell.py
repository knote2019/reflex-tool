                ...
                rx.vstack(
                    ...
                    rx.box(
                        rx.vstack(
                            ...
                            rx.hstack(
                                rx.badge("B100", color_scheme="brown", variant="soft", size="2"),
                                rx.badge("B200", color_scheme="brown", variant="soft", size="2"),
                                rx.badge("GB100", color_scheme="brown", variant="soft", size="2"),
                                rx.badge("GB200", color_scheme="brown", variant="soft", size="2"),
                                spacing="2",
                                wrap="wrap",
                            ),
                        ),
                    ...
                    rx.hstack(
                        ...
                        rx.select(
                            ...
                            on_change=State.set_modelopt_version_and_reload_blackwell,
                            size="2",
                            width="150px",
                        ),
                        rx.text(
                        ...
                        rx.select(
                            ...
                            on_change=State.set_gpu_name_and_reload_blackwell,
                            size="2",
                            width="150px",
                        ),
                        spacing="3",
                    ...
                    rx.box(
                        rx.vstack(
                            rx.hstack(
                                rx.icon(tag="layers", size=32, color="#D4A59A"),
                                rx.heading(
                    ...
                    spacing="4",
                    padding="2rem",
                    on_mount=State.load_blackwell_data,
                ),
                max_width="1200px",
            ),
            margin_left="250px",
