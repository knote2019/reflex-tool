"""Ada Architecture Inference page."""
import reflex as rx
...
def inference_ada_page() -> rx.Component:
    """Ada Architecture Inference page."""
    return rx.hstack(
        navbar(),
        rx.box(
            rx.container(
                rx.vstack(
                    # Title
                    rx.heading(
                        "Ada Architecture - Model Inference",
                        font_size="1.8rem",
                        font_weight="600",
                        margin_top="1.5rem",
                        margin_bottom="1rem",
                    ...
                    rx.hstack(
                        ...
                        rx.select(
                            ...
                            on_change=State.set_modelopt_version_and_reload_ada_inference,
                            size="2",
                            width="150px",
                        ),
                        rx.text(
                        ...
                        rx.vstack(
                            rx.hstack(
                                ...
                                rx.button(
                                    ...
                                    "refresh",
                                    on_click=lambda: [State.load_ada_inference_data, rx.toast.success("Data refreshed successfully")],
                                    variant="outline",
                                    size="2",
                                    color_scheme="blue",
                                ),
                    ...
                    spacing="4",
                    padding="2rem",
                    on_mount=State.load_ada_inference_data,
                ),
                max_width="1200px",
            ),
            margin_left="250px",
