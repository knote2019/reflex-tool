                ...
                rx.vstack(
                    ...
                    rx.hstack(
                        ...
                        rx.select(
                            ...
                            on_change=State.set_cpu_arch_and_reload_hopper_performance,
                            size="2",
                            width="150px",
                        ),
                        spacing="3",
                        ...
                        rx.vstack(
                            rx.hstack(
                                ...
                                rx.button(
                                    ...
                                    "refresh",
                                    on_click=lambda: [State.load_hopper_performance_data, rx.toast.success("Data refreshed successfully")],
                                    variant="outline",
                                    size="2",
                                    color_scheme="green",
                                ),
