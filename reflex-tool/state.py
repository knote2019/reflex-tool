...
class State(rx.State):
    ...
    def load_blackwell_data(self):
        ...
        try:
            ...
            print(
                f"Loaded {len(self.blackwell_test_data)} Blackwell records for version {self.selected_modelopt_version}")
...
"""
    ...
    def load_ampere_inference_data(self):
        ...
        try:
            ...
            print(
                f"Loaded {len(self.ampere_inference_test_data)} Ampere inference records for version {self.selected_modelopt_version}")
...
"""
    ...
    def load_ada_inference_data(self):
        ...
        try:
            ...
            print(
                f"Loaded {len(self.ada_inference_test_data)} Ada inference records for version {self.selected_modelopt_version}")
    ...
    def load_hopper_inference_data(self):
        ...
        try:
            ...
            print(
                f"Loaded {len(self.hopper_inference_test_data)} Hopper inference records for version {self.selected_modelopt_version}")
    ...
    def load_blackwell_inference_data(self):
        ...
        try:
            ...
            print(
                f"Loaded {len(self.blackwell_inference_test_data)} Blackwell inference records for version {self.selected_modelopt_version}")
    ...
    def load_ada_performance_data(self):
        ...
        try:
            ...
            print(
                f"Loaded {len(ada_performance_data)} Ada performance records for version {self.selected_modelopt_version}")
    ...
    def load_hopper_performance_data(self):
        ...
        try:
            ...
            print(
                f"Loaded {len(hopper_performance_data)} Hopper performance records for version {self.selected_modelopt_version}")
    ...
    def load_blackwell_performance_data(self):
        ...
        try:
            ...
            print(
                f"Loaded {len(blackwell_performance_data)} Blackwell performance records for version {self.selected_modelopt_version}")
