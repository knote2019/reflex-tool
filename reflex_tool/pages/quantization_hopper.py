...
def quantization_hopper_page() -> rx.Component:
    """Hopper Architecture page."""
    return rx.hstack(
        navbar(),
        rx.box(
                ...
                rx.vstack(
                    ...
                    rx.hstack(
                        ...
                        rx.select(
                            ...
                            on_change=State.set_modelopt_version_and_reload_hopper,
                            size="2",
                            width="150px",
                        ),
                        rx.text(
                        ...
                        rx.select(
                            ...
                            on_change=State.set_gpu_name_and_reload_hopper,
                            size="2",
                            width="150px",
                        ),
                        spacing="3",
                    ...
                    rx.box(
                        rx.vstack(
                            rx.hstack(
                                rx.icon(tag="layers", size=32, color="#A855F7"),
                                rx.heading(
                                ...
                                rx.button(
                                    rx.icon(tag="download", size=18),
                                    "export",
                                    on_click=State.export_hopper_quantization_csv,
                                    variant="outline",
                                    size="2",
                                    color_scheme="purple",
                                ),
                    ...
                    spacing="4",
                    padding="2rem",
                    on_mount=State.load_hopper_data,
                ),
                max_width="1200px",
            ),
            margin_left="250px",
